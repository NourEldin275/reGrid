(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("re-grid", [], factory);
	else if(typeof exports === 'object')
		exports["re-grid"] = factory();
	else
		root["re-grid"] = factory();
...
var _LocaleUtils = __webpack_require__(150);
...
var DayPickerInput = __webpack_require__(175);
...
var _columnsRow = __webpack_require__(172);

var _columnsRow2 = _interopRequireDefault(_columnsRow);

var _filtersRow = __webpack_require__(173);

var _filtersRow2 = _interopRequireDefault(_filtersRow);

var _tableBody = __webpack_require__(188);

var _tableBody2 = _interopRequireDefault(_tableBody);

var _reactPaginate = __webpack_require__(191);
...
var ReGrid = function (_Component) {
    _inherits(ReGrid, _Component);

    function ReGrid(props) {
        _classCallCheck(this, ReGrid);

        var _this = _possibleConstructorReturn(this, (ReGrid.__proto__ || Object.getPrototypeOf(ReGrid)).call(this, props));
        ...
        _this.onFilterEnterHandler = _this.onFilterEnterHandler.bind(_this);
        _this.shouldClearButtonToggle = _this.shouldClearButtonToggle.bind(_this);
        ...
        _this.onFilterDatePickerChangeHandler = _this.onFilterDatePickerChangeHandler.bind(_this);
        return _this;
    }
    ...
    _createClass(ReGrid, [{
        ...
        value: function handleSort(event) {
            ...
            var icon_DESC = 'glyphicon-sort-by-attributes-alt';
            var icon_ASC = 'glyphicon-sort-by-attributes';
            var icon_default = 'glyphicon-sort';

            // A different column was clicked or its the first time to sort
            if (this.state.sort.column !== columnName) {
                direction = 'ASC';
                var sortIcons = document.getElementsByClassName('sort-direction-toggle');
            ...
            this.setState({
                ...
                _this2.props.remoteSortHandler(_this2.state.sort);
                _this2.shouldClearButtonToggle();
            });
        }
    }, {
        key: 'onFilterChangeHandler',
        value: function onFilterChangeHandler(event) {
            var _this3 = this;

            var field = event.target;
            var filters = this.state.filters;
            var filterName = field.getAttribute('name');
            ...
            this.setState({ filters: filters }, function () {
                if (field.type === 'checkbox' || field.type === 'select-one') {
                    // Fields that require no Enter key press
                    _this3.props.remoteFilterHandler(_this3.state.filters);
                }
                _this3.shouldClearButtonToggle(); // If there are filters enable the clear button
            });
        }
        ...
        key: 'onFilterDatePickerChangeHandler',
        value: function onFilterDatePickerChangeHandler(filterName, value) {
            var _this4 = this;
            ...
            this.setState({ filters: filters }, function () {
                _this4.props.remoteFilterHandler(_this4.state.filters);
                _this4.shouldClearButtonToggle();
            });
        }
        ...
        key: 'onFilterEnterHandler',
        value: function onFilterEnterHandler(event) {
        ...
        key: 'shouldClearButtonToggle',
        value: function shouldClearButtonToggle() {

            var isClearButtonDisabled = !(Object.values(this.state.filters).length > 0);
            var buttonAndFilterClearState = { disableClearButton: isClearButtonDisabled };
        ...
        value: function onClearButtonClick() {
            ...
            this.setState({
                ...
                _this5.props.remoteFilterHandler(_this5.state.filters);
            });
        }
        ...
        value: function render() {
            ...
            if (this.onExportButtonClick) {
                exportButton = _react2.default.createElement(
                    'button',
                    { disabled: !this.props.isExportButtonEnabled, onClick: this.onExportButtonClick },
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'gridzilla-control-buttons col-md-12' },
                        _react2.default.createElement(
                            'button',
                            { disabled: this.state.disableClearButton, onClick: this.onClearButtonClick },
                            _react2.default.createElement('span', { className: 'glyphicon glyphicon-repeat', 'aria-hidden': 'true' }),
                            'Clear Filters'
                        ),
                        exportButton
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'thead',
                                null,
                                _react2.default.createElement(_columnsRow2.default, { columns: columns, onSort: this.handleSort }),
                                _react2.default.createElement(_filtersRow2.default, {
                                    columns: columns,
                            ...
                            _react2.default.createElement(_tableBody2.default, { rows: rows, editSaveHandler: this.props.editSaveHandler })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'gridzilla-pagination col-md-12' },
...
var HeaderRow = function (_Component) {
    ...
    _createClass(HeaderRow, [{
        ...
        value: function render() {
            var columns = this.props.columns;
            var sortHandler = this.props.onSort;
            var columnConfig = columns.map(function (column) {
                return _react2.default.createElement(
                    "td",
...
var _filterCell = __webpack_require__(174);
...
var HeaderFiltersRow = function (_Component) {
    _inherits(HeaderFiltersRow, _Component);

    function HeaderFiltersRow() {
        _classCallCheck(this, HeaderFiltersRow);

        return _possibleConstructorReturn(this, (HeaderFiltersRow.__proto__ || Object.getPrototypeOf(HeaderFiltersRow)).apply(this, arguments));
    }

    _createClass(HeaderFiltersRow, [{
        key: 'render',
        value: function render() {
            var _this2 = this;

            var columns = this.props.columns;
            var columnFilters = columns.map(function (column) {

                if (column.filter && column.filter.enabled) {
                    return _react2.default.createElement(
                        'td',
                        { key: column.id.toString() },
                        _react2.default.createElement(_filterCell2.default, {
                            column: column,
                            onFilterEnterHandler: _this2.props.onFilterEnterHandler,
                            onFilterChangeHandler: _this2.props.onFilterChangeHandler,
                            onFilterDatePickerChangeHandler: _this2.props.onFilterDatePickerChangeHandler,
                            clearFilter: _this2.props.clearFilters
                        })
                    );
                } else {
                    return _react2.default.createElement('td', { key: column.id.toString() });
                }
            });
    ...
    return HeaderFiltersRow;
}(_react.Component);

exports.default = HeaderFiltersRow;
...
var _DayPickerInput = __webpack_require__(26);
...
var _textInput = 'text';
var _numberInput = 'number';
var _checkboxInput = 'checkbox';
var _selectInput = 'select';
var _date = 'date';
var _format = 'YYYY/MM/DD';
var _currentYear = new Date().getFullYear();
var _fromYear = new Date(0, 0).getFullYear();
var _fromMonth = new Date(_fromYear, 0);
var _toMonth = new Date(_currentYear + 10, 11);

var FilterCell = function (_Component) {
    _inherits(FilterCell, _Component);

    function FilterCell(props) {
        _classCallCheck(this, FilterCell);

        var _this = _possibleConstructorReturn(this, (FilterCell.__proto__ || Object.getPrototypeOf(FilterCell)).call(this, props));
        ...
        if (props.column.filter.enabled && props.column.filter.type === _date) {
            state['month'] = props.column.filter.options && props.column.filter.options.fromMonth ? props.column.filter.options.fromMonth : _fromMonth;
            state['format'] = props.column.filter.options && props.column.filter.options.format ? props.column.filter.options.format : _format;
        }
        _this.state = state;
        return _this;
    }

    _createClass(FilterCell, [{
        key: 'onFilterChange',
        value: function onFilterChange(event) {
            ...
            this.setState({ value: event.target.value }, function () {
                _this2.props.onFilterChangeHandler(event);
            });
        }
    }, {
        ...
        value: function handleDayChange(selectedDay) {
            ...
            var value = selectedDay ? selectedDay.format(this.state.format) : '';

            this.setState({ value: value, selectedDay: selectedDay }, function () {
                _this3.props.onFilterDatePickerChangeHandler(_this3.props.column.id, _this3.state.value);
            });
        }
        ...
        key: 'buildFilterInput',
        value: function buildFilterInput() {
            var filterOnEnterHandler = this.props.onFilterEnterHandler;
            var column = this.props.column;
            var filterOptions = column.filter.options;
            ...
            if (column.filter || column.filter.enabled) {
                ...
                switch (column.filter.type) {
                    ...
                    case _checkboxInput:
                        ...
                        break;
                    case _selectInput:
                        var selectOptions = column.filter.options.map(function (option) {
                            return _react2.default.createElement(
                                'option',
                        ...
                        break;
                    case _date:
                        var fromMonth = filterOptions && filterOptions.fromMonth ? filterOptions.fromMonth : _fromMonth;
                        var toMonth = filterOptions && filterOptions.toMonth ? filterOptions.toMonth : _toMonth;
                        var dayPickerProps = {
                            month: this.state.month,
                            fromMonth: fromMonth,
                            toMonth: toMonth,
                            captionElement: _react2.default.createElement(YearMonthForm, {
                                fromMonth: fromMonth,
                                toMonth: toMonth,
                        ...
                        filter = _react2.default.createElement(_DayPickerInput2.default, {
                            name: column.id,
                    ...
                    case undefined:
                        ...
                        break;
                    default:
                        console.error('Unsupported input type passed as column filter type: ' + column.filter.type + ' on column ' + column.id);
                        filter = '';
                }
                return filter;
            }
...
var _DayPicker = __webpack_require__(179);

var _DayPicker2 = _interopRequireDefault(_DayPicker);

var _ModifiersUtils = __webpack_require__(151);
...
var _Caption = __webpack_require__(180);
...
var _Month = __webpack_require__(182);

var _Month2 = _interopRequireDefault(_Month);

var _Weekday = __webpack_require__(185);
...
var _Weekdays = __webpack_require__(183);
...
var _cells = __webpack_require__(190);
...
var Row = function (_Component) {
    ...
    function Row(props) {
        ...
        _this.cellChangeHandler = _this.cellChangeHandler.bind(_this);
        _this.dateCellChangeHandler = _this.dateCellChangeHandler.bind(_this);
        _this.editModeToggleHandler = _this.editModeToggleHandler.bind(_this);
    ...
    _createClass(Row, [{
        ...
        key: 'cellChangeHandler',
        value: function cellChangeHandler(event, cellId) {
            var rowData = this.state.rowData;
            var updated = rowData.map(function (cell) {
                if (cell.id === cellId) {
        ...
        key: 'dateCellChangeHandler',
        value: function dateCellChangeHandler(dateString, cellId) {
            var rowData = this.state.rowData;
            var updated = rowData.map(function (cell) {
                if (cell.id === cellId) {
        ...
        key: 'editModeToggleHandler',
        value: function editModeToggleHandler() {
            this.setState({
        ...
        value: function render() {
            ...
            var rowCells = row.map(function (cell) {
                return _react2.default.createElement(_cells.Cell, {
                    key: cell.id.toString(),
                    value: cell.value,
                    editing: cell.editing,
                    changeHandler: _this2.cellChangeHandler,
                    cellKey: cell.id.toString(),
                    editMode: _this2.state.editMode,
                    dateChangeHandler: _this2.dateCellChangeHandler
                });
            });
            ...
            return _react2.default.createElement(
                'tr',
                { onDoubleClick: this.editModeToggleHandler, onKeyUp: this.onKeyUpHandler },
                rowCells
            );
        }
    }]);
 ...
 */
var _textType = 'text';
var _numberType = 'number';
var _selectType = 'select';
var _checkboxType = 'checkbox';
var _dateType = 'date';

/**
 * Day Picker constants
 */
var _format = "YYYY/MM/DD"; //TODO: Create a list of supported formats for docs. Also formats like DD/MM/YYY cause errors.
var _currentYear = new Date().getFullYear();
var _fromYear = new Date(0, 0).getFullYear();
var _fromMonth = new Date(_fromYear, 0);
var _toMonth = new Date(_currentYear + 10, 11);
...
var EditableCell = function (_Component) {
    ...
    function EditableCell(props) {
        ...
        if (props.editing.enabled && props.editing.type === _dateType) {
            state['month'] = props.editing.options && props.editing.options.fromMonth ? props.editing.options.fromMonth : _fromMonth;
            state['format'] = props.editing.options && props.editing.options.format ? props.editing.options.format : _format;
            state['value'] = (0, _moment2.default)(new Date(props.defaultValue).toISOString()).format(state.format); //new Date(props.defaultValue).toDateString();
        }
        _this.state = state;
        return _this;
    }
    ...
    _createClass(EditableCell, [{
        ...
        value: function handleDayChange(selectedDay) {
            ...
            this.setState({ value: value, selectedDay: selectedDay }, function () {
                _this2.props.dateChangeHandler(_this2.state.value, _this2.props.cellKey);
            });
        }
        ...
        value: function getInput() {
            ...
            var settings = this.props.editing;
            ...
            switch (settings.type) {
                case _textType:
                    input = _react2.default.createElement('input', { type: 'text', value: this.props.defaultValue.toString(), onChange: this.changeHandler });
                    break;
                case _numberType:
                    if (settings.options) {
                    ...
                    break;
                case _checkboxType:
                    input = _react2.default.createElement('input', { type: 'checkbox', defaultChecked: this.props.defaultValue, onChange: this.changeHandler });
                    break;
                case _selectType:
                    var options = settings.options.options.map(function (option) {
                        return _react2.default.createElement(
                            'option',
                            { key: settings.options.options.indexOf(option), value: option.value, onChange: _this3.changeHandler },
                            option.label
                        );
                    });
                    input = _react2.default.createElement(
                        'select',
                        {
                            name: '',
                            id: '',
                            value: this.props.defaultValue, onChange: this.changeHandler },
                        options
                    );
                    break;
                case _dateType:
                    var fromMonth = settings.options && settings.options.fromMonth ? settings.options.fromMonth : _fromMonth;
                    var toMonth = settings.options && settings.options.toMonth ? settings.options.toMonth : _toMonth;
                    var dayPickerProps = {
                        month: this.state.month,
                        fromMonth: fromMonth,
                        toMonth: toMonth,
                    ...
                    input = _react2.default.createElement(_DayPickerInput2.default, {
...
var _PaginationBoxView = __webpack_require__(192);
...
var _reactAddonsCreateFragment = __webpack_require__(194);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./gridzilla.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./gridzilla.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".gridzilla-pagination{\n    /*position: absolute;*/\n}\n\n.gridzilla{\n    overflow: scroll;\n}\n\n.gridzilla-control-buttons{\n    margin: 20px 0px;\n}\n\n.gridzilla-control-buttons button{\n    margin-right: 5px;\n}\n\n.DayPicker-Caption{\n    margin-top: 25px;\n    margin-bottom: 25px;\n}\n", ""]);
...
//# sourceMappingURL=re-grid.js.map